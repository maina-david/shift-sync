      ...
      setZones((prev) =>
        prev.map((z) => {
          ...
          const clampedX = +Math.min(
            FLOOR_W / 2 - z.size[0],
            Math.max(-FLOOR_W / 2, rawX),
          ).toFixed(2);
          const clampedY = +Math.min(
            FLOOR_H / 2 - z.size[1],
            Math.max(-FLOOR_H / 2, rawY),
          ).toFixed(2);
                ...
                <div
                  ...
                  style={{
                    ...
                    backgroundColor: isSelected
                      ? zone.colorSelectedLight
                      : zone.colorLight,
                    borderColor: isSelected
                      ? zone.colorSelectedDark
                      : zone.colorDark,
                    boxShadow: isSelected
                      ? `0 0 0 2px ${zone.colorSelectedDark}`
                      : undefined,
                    opacity: 0.9,
                  }}
            ...
            <div className="p-4 space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  value={sel.label}
                  onChange={(e) =>
                    updateZone(sel.id, { label: e.target.value })
                  }
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="space-y-1.5">
                  <Label htmlFor={`${uid}-x`} className="text-xs">
                    Position X
                  </Label>
                  <Input
                    id={`${uid}-x`}
                    ...
                    onChange={(e) =>
                      updateZone(sel.id, {
                        position: [+e.target.value, sel.position[1]],
                      })
                    }
                    className="h-8 text-sm"
                  />
                ...
                <div className="space-y-1.5">
                  <Label htmlFor={`${uid}-y`} className="text-xs">
                    Position Y
                  </Label>
                  <Input
                    id={`${uid}-y`}
                    ...
                    onChange={(e) =>
                      updateZone(sel.id, {
                        position: [sel.position[0], +e.target.value],
                      })
                    }
                    className="h-8 text-sm"
                  />
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="space-y-1.5">
                  <Label htmlFor={`${uid}-w`} className="text-xs">
                    Width (units)
                  </Label>
                  <Input
                    id={`${uid}-w`}
                    ...
                    onChange={(e) =>
                      updateZone(sel.id, {
                        size: [+e.target.value, sel.size[1]],
                      })
                    }
                    className="h-8 text-sm"
                  />
                ...
                <div className="space-y-1.5">
                  <Label htmlFor={`${uid}-d`} className="text-xs">
                    Height (units)
                  </Label>
                  <Input
                    id={`${uid}-d`}
                    ...
                    onChange={(e) =>
                      updateZone(sel.id, {
                        size: [sel.size[0], +e.target.value],
                      })
                    }
                    className="h-8 text-sm"
                  />

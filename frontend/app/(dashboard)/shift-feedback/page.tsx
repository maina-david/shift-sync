        ...
        return (
          <Card key={fb.id}>
            <CardContent className="pt-4 pb-4">
              ...
              {fb.comment && (
                <p className="text-sm text-muted-foreground mb-2 leading-relaxed">{fb.comment}</p>
              )}
              <div className="flex items-center gap-2 flex-wrap">
                <BoolChip value={fb.adequatelyStaffed} trueLabel="Adequately staffed" falseLabel="Understaffed" />
                <BoolChip value={fb.wouldRepeat} trueLabel="Would repeat" falseLabel="Would not repeat" />
              </div>
            </CardContent>
          </Card>
        );
...
function TeamFeedbackTab() {
  ...
  const statCards = [
    ...
    },
    {
      ...
      value: summary ? (
        <span className="text-3xl font-bold tabular-nums">{summary.totalResponses}</span>
      ) : null,
    },
    {
            ...
            <Table>
              ...
              <TableBody>
                <TableRow>
                  ...
                  <TableCell className="text-right tabular-nums font-medium">{summary.totalResponses}</TableCell>
                </TableRow>
                <TableRow>
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-muted-foreground text-sm">Post-shift ratings and team insights</p>
        </div>
      </div>
      ...
      <Tabs defaultValue="my-feedback">
        <TabsList>
          ...
          {isManager && <TabsTrigger value="team-feedback">Team Feedback</TabsTrigger>}
        </TabsList>

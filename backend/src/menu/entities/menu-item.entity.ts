...
export class MenuItem {
  ...
  @Column({ type: 'decimal', precision: 8, scale: 2, transformer: { to: (v: number) => v, from: (v: string) => parseFloat(v) } }) price: number;
  ...
  @ManyToOne(() => Location, { nullable: true, eager: false, onDelete: 'SET NULL' })

...
export class ChecklistItemDto {
  ...
  @ApiProperty({
    description:
      'Whether this item must be completed before the checklist is considered done',
  })
  @IsBoolean()
  required: boolean;
}
...
export class CreateChecklistDto {
  ...
  @ApiProperty({
    description: 'UUID of the location this checklist belongs to',
  })
  @IsUUID()
  locationId: string;

  @ApiPropertyOptional({
    description: 'UUID of the shift this checklist is tied to',
  })
  @IsOptional()
  @IsUUID()
  shiftId?: string;
  ...
  @ApiPropertyOptional({
    description: 'UUID of the staff member assigned to complete this checklist',
  })
  @IsOptional()
  @IsUUID()
  assignedToId?: string;
